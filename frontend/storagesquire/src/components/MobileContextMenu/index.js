...
class MobileContextMenuContainer extends React.Component {
    ...
    //TODO(nvalev) Fixed event.target.id to this.event.target.id
    handleClickOutside = () => {
        if (this.props.mobileContextMenu.open && this.wrapperRef && !this.wrapperRef.current.contains(this.event.target.id)) {
